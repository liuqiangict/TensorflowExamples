...
features, labels = load_data('train.tsv')
input_fn = tf.estimator.inputs.numpy_input_fn(x={'features' : features}, y=labels, batch_size=FLAGS.batch_size, num_epochs=None, shuffle=True)
...
features, labels = load_data('train.tsv')
input_fn = tf.estimator.inputs.numpy_input_fn(x={'features' : features}, y=labels, batch_size=FLAGS.batch_size, shuffle=False)
